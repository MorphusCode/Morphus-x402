...
Get started with MORPHUS x402 AI Inference API in under 5 minutes. Now with dual-network support for both Base and Solana!
...
npm install morphus-x402-sdk
# or
pnpm install morphus-x402-sdk
...
import { X402Client } from 'morphus-x402-sdk';

const client = new X402Client({
  baseUrl: 'https://morphus.ai',
  network: 'base',
...
- **Support**: [x.ai/morphusid](https://x.ai/morphusid)
