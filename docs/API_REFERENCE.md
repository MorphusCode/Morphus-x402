...
const client = withPaymentInterceptor(
  axios.create({ baseURL: 'https://morphus.ai' }),
  account
);
...
response = client.post('https://morphus.ai/api/x402/llm/qwen', 
...
curl -X POST https://morphus.ai/api/x402/llm/qwen \
...
1. Change base URL to `https://morphus.ai`
